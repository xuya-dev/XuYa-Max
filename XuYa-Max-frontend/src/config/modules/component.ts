...
export const globalComponentsConfig: GlobalComponentConfig[] = [
  {
    ...
    component: defineAsyncComponent(
      () => import('@/components/core/layouts/xuya-settings-panel/index.vue')
    ),
    enabled: true
  },
  {
    ...
    key: 'global-search',
    component: defineAsyncComponent(
      () => import('@/components/core/layouts/xuya-global-search/index.vue')
    ),
    enabled: true
  },
  {
    ...
    key: 'screen-lock',
    component: defineAsyncComponent(
      () => import('@/components/core/layouts/xuya-screen-lock/index.vue')
    ),
    enabled: true
  },
  {
    ...
    key: 'chat-window',
    component: defineAsyncComponent(
      () => import('@/components/core/layouts/xuya-chat-window/index.vue')
    ),
    enabled: true
  },
  {
    ...
    component: defineAsyncComponent(
      () => import('@/components/core/layouts/xuya-fireworks-effect/index.vue')
    ),
    enabled: true
  },
  {
    ...
    key: 'watermark',
    component: defineAsyncComponent(
      () => import('@/components/core/others/xuya-watermark/index.vue')
    ),
    enabled: true
  }
]
