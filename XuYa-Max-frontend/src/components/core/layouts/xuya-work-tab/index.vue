...
<template>
  <div
    ...
    :class="[
      tabStyle === 'tab-card' ? 'py-1 border-b border-[var(--xuya-card-border)]' : '',
      tabStyle === 'tab-google' ? 'pt-1 pb-0 border-b border-[var(--xuya-card-border)]' : ''
    ]"
  >
    <div class="w-full overflow-hidden" ref="scrollRef">
      ...
      >
        <li
          class="xuya-card-xs inline-flex flex-cc h-8 mr-1.5 text-xs c-p hover:text-theme group"
          :class="[
        ...
        >
          ...
          >
            <XuyaSvgIcon icon="ri:close-large-fill" class="text-[10px] text-g-600" />
          </span>
          <div
    ...
    <div class="flex">
      <div
        class="flex-cc xuya-card-xs relative top-0 size-8 leading-8 text-center c-p tad-200 hover:!bg-hover-color"
        :style="{
      ...
      >
        <XuyaSvgIcon icon="iconamoon:arrow-down-2-thin" class="text-2xl text-g-700" />
      </div>
    </div>
...
<script setup lang="ts">
  ...
  import { MenuItemType } from '../../others/xuya-menu-right/index.vue'
  import { useCommon } from '@/hooks/core/useCommon'
  import { WorkTab } from '@/types'

  defineOptions({ name: 'XuyaWorkTab' })
...
<style scoped>
  ...
  .dark .google-tab.activ-tab {
    color: var(--xuya-gray-800) !important;
    background-color: var(--xuya-hover-color) !important;
  }

  .dark .google-tab.activ-tab::before,
  .dark .google-tab.activ-tab::after {
    box-shadow: 0 0 0 30px var(--xuya-hover-color);
  }

  .google-tab:not(.activ-tab):hover {
    box-sizing: border-box;
    color: var(--xuya-gray-600) !important;
    background-color: var(--xuya-gray-200) !important;
  ...
  .google-tab i:hover {
    color: var(--xuya-gray-700);
    background: var(--xuya-gray-300);
  }
