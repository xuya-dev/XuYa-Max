    ...
    >
      ...
      >
        <template #suffix>
          ...
          >
            <XuyaSvgIcon icon="fluent:arrow-enter-left-20-filled" />
          </div>
        </template>
      </ElInput>
        ...
        <div class="result w-full" v-show="searchResult.length">
          ...
          >
            ...
            >
              ...
              <XuyaSvgIcon v-show="isHighlighted(index)" icon="fluent:arrow-enter-left-20-filled" />
            </div>
          </div>
        </div>
        ...
        <div v-show="!searchVal && searchResult.length === 0 && historyResult.length > 0">
          ...
          <div class="mt-1.5 w-full">
            ...
            >
              ...
              >
                <XuyaSvgIcon icon="ri:close-large-fill" class="text-xs" />
              </div>
            </div>
          </div>
        </div>
      ...
      <template #footer>
        <div class="dialog-footer box-border flex-c border-t-d pt-4.5 pb-1">
          <div class="flex-cc">
            <XuyaSvgIcon icon="fluent:arrow-enter-left-20-filled" class="keyboard" />
            <span class="mr-3.5 text-xs text-g-700">{{ $t('search.selectKeydown') }}</span>
          </div>
          <div class="flex-c">
            <XuyaSvgIcon icon="ri:arrow-up-wide-fill" class="keyboard" />
            <XuyaSvgIcon icon="ri:arrow-down-wide-fill" class="keyboard" />
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'XuyaGlobalSearch' })
  ...
  .layout-search {
    ...
    .el-input {
      :deep(.el-input__wrapper) {
        background-color: var(--xuya-gray-200);
