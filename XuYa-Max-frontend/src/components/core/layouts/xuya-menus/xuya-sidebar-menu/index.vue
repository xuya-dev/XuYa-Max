...
<template>
  ...
  >
    ...
    >
      <XuyaLogo class="logo" @click="navigateToHome" />
          ...
          <li v-for="menu in firstLevelMenus" :key="menu.path" @click="handleMenuJump(menu, true)">
            ...
            >
              ...
              >
                ...
                <div v-if="menu.meta.showBadge" class="xuya-badge xuya-badge-dual" />
              </div>
            </ElTooltip>
          </li>
        </ul>
    ...
    >
      ...
      >
        <XuyaLogo v-if="!isDualMenu" class="logo" />
...
<script setup lang="ts">
  ...
  defineOptions({ name: 'XuyaSidebarMenu' })
