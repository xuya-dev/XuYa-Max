  ...
  <div class="menu-right">
    <Transition name="context-menu" @before-enter="onBeforeEnter" @after-leave="onAfterLeave">
      <div
        v-show="visible"
        :style="menuStyle"
        class="context-menu xuya-card-xs !shadow-xl min-w-[var(--menu-width)] w-[var(--menu-width)]"
      >
        <ul class="menu-list m-0 list-none" :style="menuListStyle">
          <template v-for="item in menuItems" :key="item.key">
            ...
            >
              ...
              <ul
                class="submenu-list xuya-card-xs absolute left-full top-0 z-[2001] hidden w-max min-w-max list-none !shadow-xl"
...
<script setup lang="ts">
  ...
  defineOptions({ name: 'XuyaMenuRight' })
...
<style scoped>
  ...
  .menu-item.has-line::after {
    ...
    height: 1px;
    content: '';
    background-color: var(--xuya-gray-300);
  }
  ...
  .menu-item.is-disabled :deep(.xuya-svg-icon) {
