    ...
    <div class="box-border flex-1 h-full max-md:h-[calc(70%-30px)]">
      <div class="flex-cb pt-4 px-4 pb-0 mb-5">
        ...
        <div class="flex-c gap-2">
          <XuyaIconButton icon="ri:phone-line" circle class="size-11 text-g-600" />
          <XuyaIconButton icon="ri:video-on-line" circle class="size-11 text-g-600" />
          <XuyaIconButton icon="ri:more-2-fill" circle class="size-11 text-g-600" />
        </div>
      </div>
      <div class="flex flex-col h-[calc(100%-85px)]">
        ...
        <div class="p-4">
          ...
          <div class="flex-cb mt-3">
            <div class="flex-c">
              <XuyaSvgIcon icon="ri:image-line" class="mr-5 c-p text-g-600 text-lg" />
              <XuyaSvgIcon icon="ri:emotion-happy-line" class="mr-5 c-p text-g-600 text-lg" />
            </div>
