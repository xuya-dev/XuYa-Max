  ...
  <div class="py-5">
    ...
    <ElRow :gutter="20">
      <ElCol :xs="24" :sm="12" :md="6" v-for="card in progressCards" :key="card.id" class="mb-5">
        <XuyaProgressCard :percentage="card.percentage" :title="card.title" :color="card.color" />
      </ElCol>
    </ElRow>
    ...
    <ElRow :gutter="20">
      <ElCol :xs="24" :sm="12" :lg="8" class="mb-5">
        <XuyaDataListCard :list="dataList" title="待办事项" subtitle="今日待处理任务" />
      </ElCol>
      <ElCol :xs="24" :sm="12" :lg="8" class="mb-5">
        <XuyaDataListCard
          :maxCount="4"
      ...
      <ElCol :xs="24" :sm="12" :lg="8" class="mb-5">
        <XuyaTimelineListCard :list="timelineData" title="最近交易" subtitle="2024年12月20日" />
      </ElCol>
    </ElRow>
