...
<script setup lang="ts">
  ...
  const formItems = computed(() => [
    { label: '客户端id', key: 'clientId', type: 'input', props: { placeholder: '请输入客户端id', clearable: true } },
    { label: '授权类型', key: 'grantType', type: 'input', props: { placeholder: '请输入授权类型', clearable: true } },
