<template>
  <div class="page-content mb-5">
    ...
    <div class="mb-15">
      ...
      <div class="count">
        <XuyaCountTo :target="1000" :duration="2000" />
      </div>
    </div>
    ...
    <div class="mb-15">
      ...
      <div class="count">
        <XuyaCountTo :target="20000" :duration="2500" prefix="¥" suffix="元" :decimals="2" />
      </div>
    </div>
    ...
    <div class="mb-15">
      ...
      <div class="count">
        <XuyaCountTo :target="2023.45" :duration="3000" :decimals="2" separator="," />
      </div>
    </div>
    ...
    <div class="mb-15">
      ...
      <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 mb-8">
        <div class="text-center" v-for="easing in easingTypes" :key="easing.type">
          ...
          <div class="count">
            <XuyaCountTo :target="easingTarget" :duration="3000" :easing="easing.type" />
          </div>
        </div>
      </div>
...
<script setup lang="ts">
  import XuyaCountTo from '@/components/core/text-effect/xuya-count-to/index.vue'
