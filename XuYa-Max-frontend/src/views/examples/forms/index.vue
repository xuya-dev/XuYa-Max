...
<template>
  <div class="pb-5">
    ...
    <div class="xuya-card p-5 !rounded-lg mt-5">
...
<script setup lang="ts">
  import XuyaWangEditor from '@/components/core/forms/xuya-wang-editor/index.vue'
  import { SearchFormItem } from '@/components/core/forms/xuya-search-bar/index.vue'
    ...
    },
    {
      ...
      render: () =>
        h(
          ...
          {
            style:
              'color: var(--xuya-gray-600); border: 1px solid var(--default-border-dashed); padding: 0px 15px; border-radius: 6px'
          },
          '我是一个自定义组件'
        )
    },
