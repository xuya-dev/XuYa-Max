...
// 查询对象存储配置列表
export function listOssConfig(query: OssConfigQuery): Promise<PageResult<OssConfigVO>> {
  return request({
...
// 查询对象存储配置详细
export function getOssConfig(ossConfigId: string | number): Promise<OssConfigVO> {
  return request({
